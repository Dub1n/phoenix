...
Build this matrix once the problem statement, aims, and solution alignment have initial content. It provides the auditor-friendly view from user needs and regulatory clauses through to implemented features and evidence.

## How to Populate

1. Start with the primary user needs and regulatory clauses identified in `00-Problem-Statement.md` and the EN 62304 / AAMI TIR45 references.
...
4. Identify the verification or validation artefact that will demonstrate compliance (e.g. automated test suite, CI report, validation command log).
