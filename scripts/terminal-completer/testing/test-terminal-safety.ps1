...
$result1 = powershell -ExecutionPolicy Bypass -File "core\enhanced-terminal-manager.ps1" -Command 'echo "Quick test successful"'
...
$result2 = powershell -ExecutionPolicy Bypass -File "core\enhanced-terminal-manager.ps1" -Command 'npm --version'
if ($LASTEXITCODE -eq 0) {
...
$startTime = Get-Date
$result3 = powershell -ExecutionPolicy Bypass -File "core\enhanced-terminal-manager.ps1" -Command 'node -e "setTimeout(() => console.log(\"This should never print\"), 60000)"'
$endTime = Get-Date
...
$result4 = powershell -ExecutionPolicy Bypass -File "core\enhanced-terminal-manager.ps1" -Command 'echo "Background test"' -Background
if ($LASTEXITCODE -eq 0) {
...
if ($Debug) {
    ...
    $result7 = powershell -ExecutionPolicy Bypass -File "core\enhanced-terminal-manager.ps1" -Command 'echo "Debug test"' -Debug
    if ($LASTEXITCODE -eq 0) {
...
Write-Host "  powershell -ExecutionPolicy Bypass -File core\enhanced-terminal-manager.ps1 -Command 'npm test'" -ForegroundColor White
Write-Host "  powershell -ExecutionPolicy Bypass -File core\enhanced-terminal-manager.ps1 -Command 'git status'" -ForegroundColor White
Write-Host "  powershell -ExecutionPolicy Bypass -File core\enhanced-terminal-manager.ps1 -Command 'npm start' -Background" -ForegroundColor White

Write-Host "`nKill hanging processes:" -ForegroundColor Cyan
Write-Host "  powershell -ExecutionPolicy Bypass -File core\kill-hanging.ps1" -ForegroundColor White 
