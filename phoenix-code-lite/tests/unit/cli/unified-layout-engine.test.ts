...
} from '../../../src/cli/unified-layout-engine';

describe('Unified Layout Engine', () => {
  
  const createTestSkinMenuDefinition = (): SkinMenuDefinition => ({
    title: 'Test Menu',
  ...
  const createTestConstraints = (): LayoutConstraints => ({
    minHeight: 25,
    minWidth: 40,
    maxWidth: 100,
    textboxLines: 3,
  ...
  describe('calculateMenuLayout', () => {
    test('should calculate layout with procedural numbering', () => {
      ...
      const layout = calculateMenuLayout(skinDefinition, constraints);
  ...
  describe('renderMenuWithLayout', () => {
    test('should render menu with procedural numbering', () => {
      ...
      try {
        renderMenuWithLayout(skinDefinition, layout, { skinId: 'test', level: 'test' });
  ...
  describe('renderSkinMenu', () => {
    test('should render skin menu with constraints', () => {
      ...
      try {
        renderSkinMenu(skinDefinition, skinContext, constraints);
