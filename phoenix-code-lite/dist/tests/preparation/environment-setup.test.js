...
const pdf_tool_validator_1 = require("../../src/preparation/pdf-tool-validator");
const regulatory_document_processor_1 = require("../../src/preparation/regulatory-document-processor");
const crypto_library_validator_1 = require("../../src/preparation/crypto-library-validator");
const audit_cryptography_validator_1 = require("../../src/preparation/audit-cryptography-validator");
const performance_baseline_validator_1 = require("../../src/preparation/performance-baseline-validator");
const qms_performance_target_validator_1 = require("../../src/preparation/qms-performance-target-validator");
const en62304_requirement_analyzer_1 = require("../../src/preparation/en62304-requirement-analyzer");
const aami_tir45_requirement_analyzer_1 = require("../../src/preparation/aami-tir45-requirement-analyzer");
const compliance_criteria_validator_1 = require("../../src/preparation/compliance-criteria-validator");
const architecture_integration_validator_1 = require("../../src/preparation/architecture-integration-validator");
describe('QMS Environment Preparation Validation', () => {
    describe('PDF Processing Tools Availability', () => {
        ...
        test('should process regulatory documents correctly', async () => {
            const processor = new regulatory_document_processor_1.RegulatoryDocumentProcessor();
            // Test EN 62304 processing
            const en62304Result = await processor.processRegulatoryDocument('VDL2/QMS/Docs/EN 62304-2006+A1-2015 Medical device software.pdf');
            ...
            const aamiResult = await processor.processRegulatoryDocument('VDL2/QMS/Docs/AAMI/AAMI TIR45-2023 Guidance on the use of AGILE practices in the development of medical device software.pdf');
    ...
    describe('Cryptographic Libraries Availability', () => {
        test('should have cryptographic libraries available', async () => {
            const cryptoValidator = new crypto_library_validator_1.CryptoLibraryValidator();
        ...
        test('should support audit trail cryptography', async () => {
            const auditCrypto = new audit_cryptography_validator_1.AuditCryptographyValidator();
    ...
    describe('Regulatory Knowledge Base Establishment', () => {
        test('should extract EN 62304 requirements', async () => {
            const en62304Analyzer = new en62304_requirement_analyzer_1.EN62304RequirementAnalyzer();
        ...
        test('should create compliance validation criteria', async () => {
            const complianceCriteria = new compliance_criteria_validator_1.ComplianceCriteriaValidator();
    ...
    describe('Architecture Validation', () => {
        test('should validate existing architecture for QMS integration', async () => {
            const architectureValidator = new architecture_integration_validator_1.ArchitectureIntegrationValidator();
