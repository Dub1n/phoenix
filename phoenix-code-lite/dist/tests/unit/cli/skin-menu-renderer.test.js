...
describe('Skin Menu Renderer', () => {
    ...
    describe('SkinMenuRenderer', () => {
        let renderer;
        beforeEach(() => {
            renderer = new skin_menu_renderer_1.SkinMenuRenderer();
        });
    ...
    describe('quickRenderSkinMenu', () => {
        test('should render skin menu quickly', () => {
            const result = (0, skin_menu_renderer_1.quickRenderSkinMenu)('phoenix-code-lite', 'main', {
                skinId: 'phoenix-code-lite',
                level: 'main'
            });
        ...
        test('should handle missing skin gracefully', () => {
            const result = (0, skin_menu_renderer_1.quickRenderSkinMenu)('nonexistent-skin', 'main', {
                skinId: 'nonexistent-skin',
                level: 'main'
            });
    ...
    describe('renderLegacyWithUnified', () => {
        test('should render legacy menu with unified engine', () => {
            const menuContent = createTestMenuContent();
            const context = createTestContext();
            const result = (0, skin_menu_renderer_1.renderLegacyWithUnified)(menuContent, context);
            expect(result).toBe(true);
        });
        test('should handle invalid menu content gracefully', () => {
            const invalidMenuContent = {
                title: 'Invalid Menu',
                sections: [{
                        heading: 'Section',
                        items: [
            ...
            const context = createTestContext();
            const result = (0, skin_menu_renderer_1.renderLegacyWithUnified)(invalidMenuContent, context);
    ...
    describe('Built-in Menu Definitions', () => {
        test('should have valid QMS menu definition', () => {
            const renderer = new skin_menu_renderer_1.SkinMenuRenderer();
    ...
    describe('Performance and Metrics', () => {
        test('should track render performance', () => {
            const renderer = new skin_menu_renderer_1.SkinMenuRenderer({ enableMetrics: true });
...
//# sourceMappingURL=skin-menu-renderer.test.js.map