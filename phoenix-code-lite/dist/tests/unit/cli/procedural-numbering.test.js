...
const skin_menu_renderer_1 = require("../../../src/cli/skin-menu-renderer");
...
describe('Procedural Numbering', () => {
    ...
    test('should generate procedural numbers correctly', async () => {
        ...
        try {
            (0, skin_menu_renderer_1.renderLegacyWithUnified)(menuContent, context);
    ...
    test('should handle menu items without hardcoded numbers', () => {
        ...
        try {
            const layout = (0, unified_layout_engine_1.calculateMenuLayout)(skinMenuDefinition, constraints);
            (0, unified_layout_engine_1.renderMenuWithLayout)(skinMenuDefinition, layout, { skinId: 'test', level: 'test' });
        ...
        const testCases = [
            {
                name: 'Main Menu',
                items: [
                    { id: 'config', label: 'Configuration', type: 'command', command: 'config' },
                    { id: 'templates', label: 'Templates', type: 'command', command: 'templates' },
                    { id: 'generate', label: 'Generate', type: 'command', command: 'generate' }
                ]
            },
            {
                name: 'Config Menu',
                items: [
                    { id: 'show', label: 'show', type: 'command', command: 'show' },
                    { id: 'edit', label: 'edit', type: 'command', command: 'edit' },
                    { id: 'templates', label: 'templates', type: 'command', command: 'templates' }
                ]
            }
        ];
...
//# sourceMappingURL=procedural-numbering.test.js.map