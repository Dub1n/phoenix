...
async function getDssRules(params) {
...
function validateRuleFilesParameter(ruleFiles) {
...
(0, globals_1.describe)('DSS Rules Injector Parameter Handling', () => {
    ...
    (0, globals_1.describe)('Valid Input Scenarios', () => {
        (0, globals_1.test)('should accept empty array and load bootstrap trilogy', async () => {
            const result = await getDssRules({ rule_files: [] });
            (0, globals_1.expect)(result).toHaveProperty('rules');
            (0, globals_1.expect)(result.rules).toContain('bootstrap trilogy');
            (0, globals_1.expect)(result.warnings).toBeUndefined();
        });
        (0, globals_1.test)('should accept null and load bootstrap trilogy', async () => {
            const result = await getDssRules({ rule_files: null });
            (0, globals_1.expect)(result).toHaveProperty('rules');
            (0, globals_1.expect)(result.rules).toContain('bootstrap trilogy');
            (0, globals_1.expect)(result.warnings).toBeUndefined();
        });
        (0, globals_1.test)('should accept array of specific rule files', async () => {
            const result = await getDssRules({
                rule_files: ['guidelines/04-validation-rules.mdc']
            });
            (0, globals_1.expect)(result).toHaveProperty('rules');
            (0, globals_1.expect)(result.rules).toContain('loaded: guidelines/04-validation-rules.mdc');
            (0, globals_1.expect)(result.warnings).toBeUndefined();
        });
        (0, globals_1.test)('should accept omitted parameter and load bootstrap trilogy', async () => {
            const result = await getDssRules({});
            (0, globals_1.expect)(result).toHaveProperty('rules');
            (0, globals_1.expect)(result.rules).toContain('bootstrap trilogy');
            (0, globals_1.expect)(result.warnings).toBeUndefined();
        });
        (0, globals_1.test)('should accept multiple rule files in array', async () => {
            const result = await getDssRules({
                rule_files: ['guidelines/04-validation-rules.mdc', 'workflows/01-quick-tasks.mdc']
            });
            (0, globals_1.expect)(result).toHaveProperty('rules');
            (0, globals_1.expect)(result.rules).toContain('loaded: guidelines/04-validation-rules.mdc');
            (0, globals_1.expect)(result.rules).toContain('loaded: workflows/01-quick-tasks.mdc');
            (0, globals_1.expect)(result.warnings).toBeUndefined();
        });
    });
    (0, globals_1.describe)('Malformed Input Scenarios', () => {
        (0, globals_1.test)('should handle comma-separated string gracefully', async () => {
            const result = await getDssRules({
                rule_files: 'guidelines/04-validation-rules.mdc,workflows/01-quick-tasks.mdc'
            });
            (0, globals_1.expect)(result).toHaveProperty('rules');
            (0, globals_1.expect)(result.rules).toContain('loaded: guidelines/04-validation-rules.mdc');
            (0, globals_1.expect)(result.rules).toContain('loaded: workflows/01-quick-tasks.mdc');
            (0, globals_1.expect)(result.warnings?.[0]).toContain('Parsed comma-separated string into array');
        });
        (0, globals_1.test)('should handle single file path string gracefully', async () => {
            const result = await getDssRules({
                rule_files: 'guidelines/04-validation-rules.mdc'
            });
            (0, globals_1.expect)(result).toHaveProperty('rules');
            (0, globals_1.expect)(result.rules).toContain('loaded: guidelines/04-validation-rules.mdc');
            (0, globals_1.expect)(result.warnings?.[0]).toContain('Wrapped single file path in array');
        });
        (0, globals_1.test)('should handle completely malformed input with fallback', async () => {
            const result = await getDssRules({
                rule_files: 'invalid-malformed-input'
            });
            (0, globals_1.expect)(result).toHaveProperty('rules');
            (0, globals_1.expect)(result.rules).toContain('bootstrap trilogy');
            (0, globals_1.expect)(result.warnings?.[0]).toContain('Falling back to bootstrap trilogy due to malformed input');
            (0, globals_1.expect)(result.error).toContain('Unable to parse string input');
        });
        (0, globals_1.test)('should handle empty string gracefully', async () => {
            const result = await getDssRules({
                rule_files: ''
            });
            (0, globals_1.expect)(result).toHaveProperty('rules');
            (0, globals_1.expect)(result.rules).toContain('bootstrap trilogy');
            (0, globals_1.expect)(result.warnings?.[0]).toContain('Empty string provided, using null');
        });
        (0, globals_1.test)('should handle whitespace-only string gracefully', async () => {
            const result = await getDssRules({
                rule_files: '   '
            });
            (0, globals_1.expect)(result).toHaveProperty('rules');
    ...
    (0, globals_1.describe)('Error Handling Scenarios', () => {
        (0, globals_1.test)('should provide helpful error messages for type mismatches', async () => {
            const result = await getDssRules({ rule_files: 123 });
            (0, globals_1.expect)(result).toHaveProperty('rules');
            (0, globals_1.expect)(result.rules).toContain('bootstrap trilogy');
            (0, globals_1.expect)(result.error).toContain('Expected array of strings or null');
            (0, globals_1.expect)(result.error).toContain('empty array');
        });
        (0, globals_1.test)('should handle array with non-string items', async () => {
            const result = await getDssRules({ rule_files: ['valid.mdc', 123, 'another.mdc'] });
            (0, globals_1.expect)(result).toHaveProperty('rules');
            (0, globals_1.expect)(result.rules).toContain('bootstrap trilogy');
            (0, globals_1.expect)(result.error).toContain('Expected array of strings, but received array with non-string items');
        });
        (0, globals_1.test)('should handle boolean input', async () => {
            const result = await getDssRules({ rule_files: true });
            (0, globals_1.expect)(result).toHaveProperty('rules');
            (0, globals_1.expect)(result.rules).toContain('bootstrap trilogy');
            (0, globals_1.expect)(result.error).toContain('Expected array of strings or null');
        });
        (0, globals_1.test)('should handle object input', async () => {
            const result = await getDssRules({ rule_files: { key: 'value' } });
            (0, globals_1.expect)(result).toHaveProperty('rules');
            (0, globals_1.expect)(result.rules).toContain('bootstrap trilogy');
            (0, globals_1.expect)(result.error).toContain('Expected array of strings or null');
        });
        (0, globals_1.test)('should never fail completely', async () => {
            const result = await getDssRules({ rule_files: 'any-malformed-input' });
            (0, globals_1.expect)(result).toHaveProperty('rules');
            (0, globals_1.expect)(result.rules).toBeDefined();
            (0, globals_1.expect)(result.rules?.length).toBeGreaterThan(0);
        });
    });
    (0, globals_1.describe)('Edge Cases', () => {
        (0, globals_1.test)('should handle undefined parameter', async () => {
            const result = await getDssRules({ rule_files: undefined });
            (0, globals_1.expect)(result).toHaveProperty('rules');
            (0, globals_1.expect)(result.rules).toContain('bootstrap trilogy');
            (0, globals_1.expect)(result.warnings).toBeUndefined();
        });
        (0, globals_1.test)('should handle array with empty strings', async () => {
            const result = await getDssRules({ rule_files: ['', 'valid.mdc', ''] });
            (0, globals_1.expect)(result).toHaveProperty('rules');
            (0, globals_1.expect)(result.rules).toContain('loaded: valid.mdc');
            (0, globals_1.expect)(result.warnings).toBeUndefined();
        });
        (0, globals_1.test)('should handle comma-separated string with empty items', async () => {
            const result = await getDssRules({
                rule_files: 'guidelines/04-validation-rules.mdc,,workflows/01-quick-tasks.mdc,'
            });
            (0, globals_1.expect)(result).toHaveProperty('rules');
    ...
    (0, globals_1.describe)('Performance and Reliability', () => {
        (0, globals_1.test)('should complete within reasonable time for valid inputs', async () => {
        ...
        (0, globals_1.test)('should complete within reasonable time for malformed inputs', async () => {
            const startTime = Date.now();
            await getDssRules({ rule_files: 'malformed-input' });
            const endTime = Date.now();
            (0, globals_1.expect)(endTime - startTime).toBeLessThan(1000); // Should complete within 1 second
        });
        (0, globals_1.test)('should handle large comma-separated strings', async () => {
            ...
            (0, globals_1.expect)(result).toHaveProperty('rules');
            (0, globals_1.expect)(result.rules).toContain('loaded: file1.mdc');
            (0, globals_1.expect)(result.rules).toContain('loaded: file10.mdc');
            (0, globals_1.expect)(result.warnings?.[0]).toContain('Parsed comma-separated string into array');
        });
    });
});
(0, globals_1.describe)('DSS Rules Injector System Integration', () => {
    (0, globals_1.test)('should work with existing agent workflows', async () => {
        // Test current agent usage patterns
        const result = await getDssRules({ rule_files: [] });
        (0, globals_1.expect)(result).toHaveProperty('rules');
        (0, globals_1.expect)(result.rules?.length).toBeGreaterThan(0);
    });
    (0, globals_1.test)('should handle malformed input from agents gracefully', async () => {
    ...
    (0, globals_1.test)('should maintain performance with valid inputs', async () => {
        const startTime = Date.now();
        await getDssRules({ rule_files: [] });
        const endTime = Date.now();
        (0, globals_1.expect)(endTime - startTime).toBeLessThan(1000); // Should complete within 1 second
...
//# sourceMappingURL=dss-rules-injector-parameter-handling.test.js.map