...
class ConfigurationTemplates {
    ...
    static getTemplateMetadata(name) {
    ...
    static createCustomTemplate(name, baseTemplate, customizations) {
    ...
    static mergeTemplates(base, override) {
        const merged = { ...base };
    ...
    static exportTemplate(name, template, metadata) {
        const exportData = {
            metadata,
            template,
