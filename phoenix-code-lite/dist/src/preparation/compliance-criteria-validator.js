...
exports.ComplianceCriteriaValidator = void 0;
class ComplianceCriteriaValidator {
    /**
     * Create validation criteria for QMS compliance
     */
    async createValidationCriteria() {
        return {
            en62304: {
     ...
     */
    async validateCompliance(criteria, actualCompliance) {
        const issues = [];
        let totalChecks = 0;
        let passedChecks = 0;
...
exports.ComplianceCriteriaValidator = ComplianceCriteriaValidator;
//# sourceMappingURL=compliance-criteria-validator.js.map