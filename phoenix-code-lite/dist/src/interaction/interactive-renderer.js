...
exports.InteractiveRenderer = void 0;
...
class InteractiveRenderer {
    ...
    async handleInput(definition, context) {
        try {
            ...
            choices.push({ name: '🔙 Back', value: 'back', short: 'back' }, { name: '🏠 Home', value: 'home', short: 'home' }, { name: '❓ Help', value: 'help', short: 'help' }, { name: '🚪 Quit', value: 'quit', short: 'quit' });
     ...
     */
    createChoices(definition, context) {
        const choices = [];
     ...
     */
    findItemByChoice(choice, definition) {
        for (const section of definition.sections) {
