...
class ErrorHandler {
    constructor() {
        ...
        this.auditLogger = new audit_logger_1.AuditLogger('error-handler');
     ...
     */
    async executeStrategy(errorInfo) {
     ...
     */
    async logHandlingResult(errorInfo, result) {
