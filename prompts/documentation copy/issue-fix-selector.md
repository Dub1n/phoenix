...
- **🔄 CONSOLIDATION FIRST**: Check existing tasks for consolidation opportunities before creating new ones
...
### 🔄 Task Consolidation Decision Process (NEW)

**MANDATORY: Before Creating New Tasks**

#### Consolidation Analysis Checklist

**Step 1: Existing Task Search**:
```bash
# Search for related functionality
grep -i "[component-name|domain|functionality]" *-active-tasks.md
```

**Step 2: Consolidation Evaluation**:

**✅ CONSOLIDATE When** (Append to existing task):
- [ ] Same files being modified (>70% file overlap)
- [ ] Same functional domain (backend, frontend, testing, etc.)
- [ ] Related implementation patterns or expertise
- [ ] Combined complexity reasonable (<50 points total)
- [ ] Logical implementation sequence possible
- [ ] Same architectural layer (core, interface, integration)

**🆕 NEW TASK When** (Create separate task):
- [ ] Different domains requiring different expertise
- [ ] Minimal file overlap (<30%)
- [ ] Independent implementation possible
- [ ] Combined complexity too high (>50 points)
- [ ] Conflicting implementation approaches
- [ ] Different architectural patterns required

**Step 3: Implementation Strategy**:

**For Consolidation** (Append to existing):
1. Update existing task title to reflect expanded scope
2. Add discovered issue to "Consolidated From" section
3. Expand "Implementation Approach" with new steps
4. Update complexity score (sum of individual complexities)
5. Preserve all implementation details from both sources
6. Ensure coherent epic scope maintained

**Example Consolidation Update**:
```markdown
- [TASK-EXISTING] **Enhanced [Original] System** → **Enhanced [Original + New] Integration System**
  - **Consolidated From**: TASK-ORIGINAL (12) + TASK-DISCOVERED (8)
  - **Implementation Approach**:
    1. Original functionality (existing steps)
    2. NEW: Additional discovered functionality
    3. Integrated validation and testing
  - **Complexity**: 20 (12+8)
```

**Quality Gates for Consolidation**:
- [ ] Epic scope remains coherent and logical
- [ ] No forced combination of unrelated functionality
- [ ] Implementation sequence flows naturally
- [ ] Combined effort reasonable for single workflow session
- [ ] All patterns and implementation guidance preserved
...
- **Creating fragmented tasks when consolidation is appropriate** (use consolidation process above)
- **Duplicate or overlapping functionality across multiple tasks** (consolidate instead)
