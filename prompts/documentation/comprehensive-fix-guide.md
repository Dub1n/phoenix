...
### Step 5: CRITICAL - Working State Principle 🚨 **NEW**
...
1. **Immediate Documentation**: Add task directly to `templum-active-tasks.md`
2. **Classification**: Use `templum-roadmap.md` Task Classification Guide:
   - Determine phase assignment (Foundation/Interface/Integration)
   - Calculate priority score (Impact + Complexity + Urgency)
   - Identify dependencies using roadmap dependency chains
3. **Placement**: Add to appropriate queue with proper [!], [1-9], or [ ] marker
