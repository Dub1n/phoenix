...
- Task must be in [T] implemented-testing status (validation passed)
...
- [ ] Confirm task is marked [T] in `<project>-active-tasks.md`
...
- [ ] Update task status from [T] to [x] in `<project>-active-tasks.md`
