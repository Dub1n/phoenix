...
- ⚠️ haruspex - Health: unhealthy - Disconnected Not available
- ⚠️ pcl - Health: unhealthy - Disconnected Not available
- ⚠️ litany - Health: unhealthy - Disconnected Not available
 ──────────────
  🔙 Back
  🏠 Main Menu
  ❓ Help
...
##### Current List Connected Services
...
✔ › Select an option: 📋 List Connected Services - Show all currently connected backend services

⚡ Executing: services:list

🌐 Backend Service Status:
┌──────────┬──────────────┬───────────┬──────────┬────────────────────────────────────────┐
│ service  │ status       │ health    │ response │ capabilities                           │
├──────────┼──────────────┼───────────┼──────────┼────────────────────────────────────────┤
│ haruspex │ Disconnected │ unhealthy │ N/A      │ analysis, prediction                   │
│ pcl      │ Disconnected │ unhealthy │ N/A      │ tdd-workflow, testing                  │
│ litany   │ Disconnected │ unhealthy │ N/A      │ context-management, memory-integration │
└──────────┴──────────────┴───────────┴──────────┴────────────────────────────────────────┘
