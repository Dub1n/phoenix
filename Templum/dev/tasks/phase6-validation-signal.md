...
- [ ] Stand up a high-fidelity IPC/mock backend that mirrors Haruspex/PCL behaviour (using the example backend as a starting point) and switch the Phase 6 harness/tests to it so partner-specific logic is exercised pre-integration.
