...
- Required follow-up: repair the coverage stack, introduce suite-specific configs and thresholds, and ensure governance scripts exit cleanly before updating documentation/checklists.
