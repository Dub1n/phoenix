...
- If any upstream stage (especially Stage 3/5/6) is reopened, the CLI will automatically drop Stage 7 back to `pending` and block it until prerequisites return to `complete`; treat the printed cascade list as a TODO checklist.
