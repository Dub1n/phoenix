...
TASK-ID: TASK-VERIFY-QUALITY-001
...
# Validation Report - TASK-VERIFY-QUALITY-001 - 2025-09-11T15-46

## Validation Category: Code Quality Assessment

**Overall Status**: VALIDATION_FAILED
**Execution Time**: 5532ms
**Tests Executed**: 4
...
8. Complexity analysis: src/cli-entry.ts (complexity: 50)
...
23. Debt assessment: src/cli-entry.ts (53 indicators)
...
33. Debt assessment: src/interfaces/cli-adapter-abstracted.ts (133 indicators)
34. Debt assessment: src/interfaces/cli-adapter.ts (125 indicators)
35. Debt assessment: src/interfaces/command-adapter-abstracted.ts (15 indicators)
...
58. Maintainability score: src/cli-entry.ts (50/100)
...
68. Maintainability score: src/interfaces/cli-adapter-abstracted.ts (50/100)
69. Maintainability score: src/interfaces/cli-adapter.ts (40/100)
70. Maintainability score: src/interfaces/command-adapter-abstracted.ts (50/100)
...
- **Status**: FAIL
- **Duration**: 5532ms
- **Timestamp**: 2025-09-11T15:46:33.092Z
- **Tests Passed**: 0
- **Tests Failed**: 4
- **Tests Warned**: 0
