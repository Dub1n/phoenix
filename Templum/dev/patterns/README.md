...
| ----------------------------------------------------------------------------------------- | ------------ | --------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [abstraction-layer-architecture](abstraction-layer-architecture.md)                       | established  | foundation                  | abstraction, dependency-inversion, interface-adapters, orchestrator, decoupling, testability                                                                 |
| [accessibility-compliance-cli-interfaces](accessibility-compliance-cli-interfaces.md)     | established  | infrastructure              | accessibility-compliance, wcag-2-1-aa, screen-reader-support, keyboard-navigation, assistive-technologies, semantic-markup, inclusive-design                 |
| [adaptive-mcp-integration](adaptive-mcp-integration.md)                                   | established  | integration                 | mcp-integration, adaptive-timeout, circuit-breaker, fallback-strategies, connection-resilience, cli-validation                                               |
| [advanced-compatibility-validation](advanced-compatibility-validation.md)                 | ESTABLISHED  | Infrastructure              | validation, compatibility, interfaces, performance, structural, cross-platform, multi-dimensional, constraints                                               |
| [async-utils](utilities/core/async-utils.md)                                              | [x]          | core-infrastructure         | async-utilities, timeout-management, retry-logic, debouncing, throttling, promise-utilities                                                                  |
| [backend-service-integration-unified](backend-service-integration-unified.md)             | ESTABLISHED  | Integration                 | backend-integration, protocol-abstraction, skin-driven, generic-factory, multi-protocol                                                                      |
| [bordered-window-layout](bordered-window-layout.md)                                       | established  | ui                          | window-borders, terminal-layout, cli-design, visual-structure, procedural-rendering                                                                          |
...
| [circuit-breaker-resilience](circuit-breaker-resilience.md)                               | ESTABLISHED  | Infrastructure              | circuit-breaker, resilience, error-recovery, fault-tolerance, cascading-failures, isolation                                                                  |
| [cli-process-separation](cli-process-separation.md)                                       | established  | architecture                | cli-separation, process-architecture, service-discovery, ipc-communication, headless-deployment, multi-terminal                                              |
| [cli-visual-design-structured-windows](cli-visual-design-structured-windows.md)           | established  | integration                 | structured-windows, border-rendering, unicode-fallback, terminal-compatibility, progressive-enhancement, emoji-elimination, accessibility-compliance         |
| [configuration-management](configuration-management.md)                                   | ESTABLISHED  | Foundation                  | configuration, config-management, schema-bridging, templum-config-manager, component-initialization, environment-detection                                   |
| [configuration-utils](utilities/system/configuration-utils.md)                            | established  | system                      | configuration, environment-variables, schema-validation, file-management, hot-reload                                                                         |
| [core-component-unit-testing](core-component-unit-testing.md)                             | established  | foundation                  | unit-testing, mock-management, integration-testing, backend-validation, jest, typescript, service-discovery, connection-factory                              |
| [cross-separator-navigation](cross-separator-navigation.md)                               | established  | ui                          | menu-navigation, separator-handling, exit-behavior, keyboard-input, raw-mode, confirmation-dialogs                                                           |
| [debug-utils](utilities/dev/debug-utils.md)                                               | [~]          | development-tools           | debug-toolkit, profiling, state-inspection                                                                                                                   |
| [dependency-injection-unified](dependency-injection-unified.md)                           | ESTABLISHED  | Infrastructure              | dependency-injection, adapter-pattern, initialization, lifecycle-management, validation                                                                      |
...
| [dynamic-command-router-integration](dynamic-command-router-integration.md)               | established  | integration                 | dynamic-command-router, menu-integration, registry-systems, backward-compatibility, skin-driven                                                              |
| [dynamic-command-routing](dynamic-command-routing.md)                                     | established  | integration                 | dynamic-routing, command-mapping, backend-integration, skin-definitions, runtime-configuration, generic-routing                                              |
| [dynamic-local-command-detection](dynamic-local-command-detection.md)                     | established  | routing                     | dynamic-routing, command-detection, skin-definition-driven, routing-accuracy, backward-compatibility                                                         |
| [dynamic-routing-initialization](dynamic-routing-initialization.md)                       | established  | initialization              | lazy-initialization, routing-startup, error-handling, performance-optimization, graceful-degradation                                                         |
| [efficient-fallback](efficient-fallback.md)                                               | established  | integration                 | fallback, null-check, performance, graceful-degradation, exception-handling, error-reduction                                                                 |
| [emoji-elimination-systematic-replacement](emoji-elimination-systematic-replacement.md)   | established  | infrastructure              | emoji-elimination, systematic-replacement, text-equivalents, batch-processing, accessibility-compliance, clean-design, unicode-cleanup                       |
| [end-to-end-testing-scenarios](end-to-end-testing-scenarios.md)                           | established  | testing                     | e2e-testing, integration-testing, performance-monitoring, workflow-validation, cross-interface-testing, mock-services, jest-framework                        |
| [enhanced-backendconfig-schema](enhanced-backendconfig-schema.md)                         | established  | foundation                  | backend-config, connection-schema, protocol-support, authentication, service-discovery, backward-compatibility                                               |
| [enhanced-menu-integration](enhanced-menu-integration.md)                                 | established  | integration                 | menu-integration, backward-compatibility, hybrid-architecture, performance-optimization, progressive-enhancement                                             |
| [enhanced-skin-registration-validation](enhanced-skin-registration-validation.md)         | established  | foundation                  | skin-registration, validation, version-management, conflict-detection, error-handling, universal-skin-engine                                                 |
| [enhanced-validation-testing](enhanced-validation-testing.md)                             | established  | testing                     | validation-testing, autonomous-systems, safety-framework, agent-integration, rollback-recovery, audit-trail, production-readiness, quality-gates             |
| [error-handler](utilities/core/error-handler.md)                                          | [x]          | core-infrastructure         | error-handling, catch-block-consolidation, error-recovery, timeout-management, structured-errors                                                             |
| [error-recovery](error-recovery.md)                                                       | established  | foundation                  | error-recovery, fallback-rendering, graceful-degradation, system-availability, fault-tolerance, integration-failure, circuit-breaker, resilience             |
| [event-utils](utilities/core/event-utils.md)                                              | [x]          | core-infrastructure-utility | event-utilities, typed-events, event-emitter-consolidation, subscription-management, automatic-cleanup, event-bus                                            |
| [factory-registry-with-context-management](factory-registry-with-context-management.md)   | established  | foundation                  | factory-pattern, registry, context-management, error-boundaries, vscode-extension, dependency-injection                                                      |
| [factory-utils](utilities/core/factory-utils.md)                                          | [!]          | core-infrastructure         | factory-utils, factory-registry, strategy-orchestration                                                                                                      |
| [file-based-handoff-infrastructure](file-based-handoff-infrastructure.md)                 | established  | foundation                  | agent-communication, context-isolation, handoff, json-schemas, file-system, workflow, audit-trail                                                            |
| [generic-agent-template](generic-agent-template.md)                                       | established  | foundation                  | agent-template, context-isolation, handoff-protocol, cross-project, research-automation                                                                      |
| [http-protocol-communication](http-protocol-communication.md)                             | established  | infrastructure              | http, pcl-integration, backend-communication, api-endpoints, error-handling, timeout-handling, service-mapping                                               |
| [hybrid-cli-development-testing](hybrid-cli-development-testing.md)                       | established  | testing-integration         | hybrid-synthesis, cli-development, agent-interaction, multi-category-validation, context-preservation                                                        |
| [integration-test-framework-transition](integration-test-framework-transition.md)         | established  | testing                     | integration-testing, jest, public-api, mock-elimination, real-behavior-validation                                                                            |
| [interface-adapter-integration-testing](interface-adapter-integration-testing.md)         | established  | testing                     | interface-adapters, integration-testing, orchestrator, testing-framework, mock-implementation, cross-interface, state-synchronization                        |
| [ipc-protocol-communication](ipc-protocol-communication.md)                               | established  | integration                 | ipc, inter-process-communication, backend-service, haruspex, childprocess, real-time-messaging                                                               |
| [library-module-interop-resolution](library-module-iterop-resolution.md)                  | experimental | foundation                  | typescript, esmodule, interop, compilation, library-integration, zod, configuration                                                                          |
| [logger](utilities/core/logger.md)                                                        | [x]          | core-infrastructure         | logging, console-consolidation, structured-logging, context-management, performance-tracking                                                                 |
| [mcp-integration-preservation-ui-changes](mcp-integration-preservation-ui-changes.md)     | established  | integration                 | mcp-preservation, agent-cli-compatibility, backward-compatibility, ui-transformation, command-mapping, session-management, mcp-bridge                        |
| [mcp-pty-integration](mcp-pty-integration.md)                                             | established  | foundation                  | mcp, pty, terminal, session-management, cross-platform, mock-development                                                                                     |
| [minimal-compilation-stabilization-pattern](minimal-compilation-stabilization-pattern.md) | established  | foundation                  | compilation, stabilization, dependencies, typescript, test-fixes, scope-discipline, error-reduction                                                          |
| [mock-real-api-alignment](mock-real-api-alignment.md)                                     | established  | foundation                  | api-alignment, typescript-interfaces, mocks, testing, compilation-errors, interface-conflicts                                                                |
| [mock-real-api-contract-testing](mock-real-api-contract-testing.md)                       | experimental | testing                     | contract-testing, mock-validation, api-consistency, test-infrastructure, automated-testing                                                                   |
| [multi-strategy-service-discovery](multi-strategy-service-discovery.md)                   | established  | infrastructure              | service-discovery, backend-integration, multi-strategy, dynamic-configuration, endpoint-scanning, registry-based                                             |
...
| [node.js-type-system-alignment](node.js-type-system-alignment.md)                         | established  | foundation                  | nodejs, typescript, websocket, imports, scoping, constructors, type-system                                                                                   |
| [observability-infrastructure](observability-infrastructure.md)                           | established  | foundation                  | observability, logging, metrics, monitoring, alerting, structured-logging, performance, debugging                                                            |
| [path-utils](utilities/system/path-utils.md)                                              | [~]          | system                      | safe-paths, sandbox-io, confidence-scoring, cross-platform                                                                                                   |
| [pcl-component-integration-unified](pcl-component-integration-unified.md)                 | established  | integration                 | pcl, component, integration, performance, validation, health-analysis, real-components, measurement                                                          |
| [pcl-enhanced-rendering](pcl-enhanced-rendering.md)                                       | established  | integration                 | pcl-rendering, theme-adapter, component-styling, universal-menu-item, type-specific-styling, visual-enhancement                                              |
| [pcl-rendering-integration-bridge-pattern](pcl-rendering-integration-bridge.md)           | established  | integration                 | rendering, pcl-integration, universal-skin-engine, bridge-pattern, theme-mapping, layout-engine                                                              |
| [performance-utils](utilities/system/performance-utils.md)                                | [x]          | system                      | performance, timing, metrics, telemetry                                                                                                                      |
| [production-readiness-validation](production-readiness-validation.md)                     | established  | testing                     | production-readiness, system-validation, real-metrics, deployment-assessment, performance-validation, resource-management, error-handling, system-health     |
| [progressive-enhancement-terminal-ui](progressive-enhancement-terminal-ui.md)             | established  | infrastructure              | progressive-enhancement, terminal-compatibility, capability-detection, adaptive-ui, fallback-strategies, environment-detection, graceful-degradation         |
| [protocol-communication-overview](protocol-communication-overview.md)                     | established  | infrastructure              | protocol, communication, backend-integration, ipc, http, websocket, service-integration                                                                      |
| [protocol-utils](utilities/core/protocol-utils.md)                                        | [x]          | core-infrastructure-utility | protocol-utilities, connection-management, message-validation, confidence-scoring, protocol-optimization, health-monitoring                                  |
| [real-implementation-integration](real-implementation-integration.md)                     | established  | integration                 | implementation-integration, placeholder-replacement, universal-skin-engine, error-handling, fallback-coordination, real-implementations                      |
| [registry-utils](utilities/registry-utils.md)                                             | x            | core-infrastructure         | registry-utils, lifecycle-management, dependency-injection, confidence-scoring                                                                               |
| [resilience-utils-consolidation-pattern](utilities/resilience-utils.md)                   | pending      | resilience-infrastructure   | resilience-utilities, fallback-strategies, performance-monitoring, rollback-automation, risk-mitigation, system-recovery                                     |
...
| [session-management-unified](session-management-unified.md)                               | established  | integration                 | session-management, interface-coordination, state-preservation, error-recovery, multi-backend, session-lifecycle                                             |
| [skin-versioning-system](skin-versioning-system.md)                                       | established  | infrastructure              | versioning, semantic-versioning, skin-management, conflict-resolution, migration, compatibility, caching                                                     |
| [templum-resource-management-unified](templum-resource-management-unified.md)             | established  | infrastructure              | resource-management, memory-allocation, connection-pooling, policy-enforcement, service-health, automated-cleanup, resource-tracking, performance-monitoring |
| [templumerror-integration](templumerror-integration.md)                                   | established  | foundation                  | error-handling, typescript, error-interfaces, error-categorization, monitoring, debugging, type-safety, signal-system                                        |
...
| [terminal-state-management](terminal-state-management.md)                                 | established  | infrastructure              | terminal, state-management, inquirer, cli, stdin, process-control                                                                                            |
| [terminal-ui-components](terminal-ui-components.md)                                       | established  | integration                 | terminal-ui, cli-components, progress-bars, interactive-prompts, responsive-layout, chalk-theming                                                            |
| [test-health-monitoring](test-health-monitoring.md)                                       | established  | foundation                  | test-health, monitoring, pre-commit, coverage, validation, infrastructure, quality-gates                                                                     |
| [test-infrastructure-repair](test-infrastructure-repair.md)                               | established  | foundation                  | test-infrastructure, typescript, compilation-errors, type-system, test-repair, interface-alignment                                                           |
| [test-type-system-alignment](test-type-system-alignment.md)                               | established  | foundation                  | type-alignment, test-interfaces, typescript-compilation, dual-type-system, TDD-workflow, interface-contracts, templum-types, universal-skin-engine-types     |
...
| [type-conversion](type-conversion.md)                                                     | established  | foundation                  | type-conversion, type-safety, interface-bridging, legacy-compatibility, design-tokens, theme-conversion                                                      |
...
| [typescript-configuration-optimization](typescript-configuration-optimization.md)         | established  | configuration               | typescript, configuration, performance, compilation, module-resolution, esmodule-interop                                                                     |
| [unified-type-system](unified-type-system.md)                                             | established  | foundation                  | typescript, compilation, error-handling, type-system, map-iteration, signals, templum-types                                                                  |
| [universal-interface-orchestration](universal-interface-orchestration.md)                 | established  | integration                 | interface-switching, session-preservation, universal-skin-engine, validation, error-recovery, performance-monitoring, orchestration                          |
| [universal-skin-engine](universal-skin-engine.md)                                         | established  | foundation                  | rendering, theming, cross-platform, version-management, interface-types, universal, engine, pcl-integration                                                  |
| [unused-variable-cleanup-automation](unused-variable-cleanup-automation.md)               | established  | quality                     | eslint, typescript, automation, unused-variables, imports, code-quality, compilation                                                                         |
...
| [vscode-extension-activation-pattern](vscode-extension-activation-pattern.md)             | established  | foundation                  | vscode, extension, activation, webview, commands, lifecycle, graceful-degradation                                                                            |
| [vscode-extension-configuration](vscode-extension-configuration.md)                       | established  | foundation                  | vscode, extension, configuration, manifest, package.json, cli-conversion, activation-events, view-contributions                                              |
| [vscode-extension-integration-system](vscode-extension-integration-system.md)             | established  | integration                 | vscode-extension, service-discovery, interface-switching, connection-management, resource-cleanup, tree-provider, templum-core                               |
| [vscode-service-tree-provider](vscode-service-tree-provider.md)                           | established  | infrastructure              | vscode, tree-provider, conditional-display, backend-capability-profile, service-tree, visual-indicators                                                      |
| [websocket-protocol-communication](websocket-protocol-communication.md)                   | established  | integration                 | websocket, real-time, bidirectional, protocol, litany, backend-service, messaging                                                                            |
...
| Pattern                                                                   | Status     | Category   | Keywords                                                                                       |
| ------------------------------------------------------------------------- | ---------- | ---------- | ---------------------------------------------------------------------------------------------- |
| [backend-integration-feature-flags](backend-integration-feature-flags.md) | deprecated | foundation | feature-flags, backend-integration, progressive-enhancement, hybrid-modes, fallback-mechanisms |
<!-- /PATTERN:DEPRECATED_TABLE -->
...
<!-- PATTERN:DETAIL_LIST -->
- [abstraction-layer-architecture](abstraction-layer-architecture.md) | 2025-09-11-1217 | foundation | Complete abstraction layer with interface contracts enabling dependency inversion for all interface adapters, decoupling concrete implementations from interface layer
  - use-when:
...
- [accessibility-compliance-cli-interfaces](accessibility-compliance-cli-interfaces.md) | 2025-09-12-174343 | infrastructure | WCAG 2.1 AA compliant CLI interface design with screen reader support, keyboard navigation accessibility, and semantic markup for assistive technologies
  - use-when:
...
- [adaptive-mcp-integration](adaptive-mcp-integration.md) | 2025-09-13-103229 | integration | MCP integration with adaptive timeout handling, circuit breaker patterns, and intelligent fallback mechanisms for robust CLI validation testing
  - use-when:
...
- [advanced-compatibility-validation](advanced-compatibility-validation.md) | 2025-09-11-0000 | Infrastructure | Multi-dimensional compatibility validation system with configurable depth, interface-specific requirements, performance constraint validation, and comprehensive reporting with actionable recommendations
  - use-when:
...
- [async-utils](utilities/core/async-utils.md) | 2025-09-14T18:15:00Z | core-infrastructure | Centralized async utilities to eliminate 316 setTimeout/setInterval calls with automatic cleanup, retry logic, and debouncing/throttling
  - use-when:
...
- [backend-integration-feature-flags](backend-integration-feature-flags.md) | 2025-09-11-1217 | foundation | Feature flag system enabling progressive enhancement with hybrid modes and automatic fallback mechanisms.
  - use-when:
...
- [backend-service-integration-unified](backend-service-integration-unified.md) | 2025-09-11-121733 | Integration | Fully generic, skin-driven backend integration supporting multiple protocols with zero Templum code changes for new backends
  - use-when:
...
- [bordered-window-layout](bordered-window-layout.md) | 2025-09-13-103229 | ui | Enhanced window rendering system with borders, centered titles, and consistent padding for CLI design specification compliance
  - use-when:
...
- [circuit-breaker-resilience](circuit-breaker-resilience.md) | 2025-09-11-0000 | Infrastructure | Circuit breaker implementation with operation-specific tracking, Templum error integration, signal emission, and specialized factory patterns
  - use-when:
...
- [cli-process-separation](cli-process-separation.md) | 2025-09-11-0000 | architecture | Architectural separation of service and CLI into independent processes with IPC-based service discovery
  - use-when:
...
- [cli-visual-design-structured-windows](cli-visual-design-structured-windows.md) | 2025-09-12-174343 | integration | Structured window rendering system with Unicode box-drawing and ASCII fallback for clean, emoji-free CLI interfaces with proper padding and progressive enhancement
  - use-when:
...
- [configuration-management](configuration-management.md) | 2025-09-11-0000 | Foundation | Bridge comprehensive configuration with simplified component-specific configuration interfaces
  - use-when:
...
- [configuration-utils](utilities/system/configuration-utils.md) | 2025-09-14T14:12:30Z | system | Unified configuration loading utilities covering environment parsing, schema validation, file persistence, and hot reloading
  - use-when:
...
- [core-component-unit-testing](core-component-unit-testing.md) | 2025-09-11-0000 | foundation | Comprehensive unit testing pattern with mock management, integration test orchestration, and real backend validation for critical components
  - use-when:
...
- [cross-separator-navigation](cross-separator-navigation.md) | 2025-09-13-103229 | ui | Enhanced menu navigation system with proper separator handling, exit behavior, and keyboard responsiveness for CLI interfaces
  - use-when:
...
- [dependency-injection-unified](dependency-injection-unified.md) | 2025-09-11-0000 | Infrastructure | Complete 4-phase dependency injection system with enhanced adapters, systematic initialization, and validation
  - use-when:
...
- [dynamic-command-router-integration](dynamic-command-router-integration.md) | 2025-09-11-121733 | integration | Menu and registry systems need to integrate with DynamicCommandRouter for skin-driven command routing while maintaining backward compatibility with legacy hardcoded patterns
  - use-when:
...
- [dynamic-command-routing](dynamic-command-routing.md) | 2025-09-11-0000 | integration | Dynamic command routing system that eliminates hardcoded patterns by building routing tables from skin definitions at runtime
  - use-when:
...
- [dynamic-local-command-detection](dynamic-local-command-detection.md) | 2025-09-13-103229 | routing | Dynamic command routing system that replaces hardcoded command detection with skin-definition based routing for flexible CLI command resolution
  - use-when:
...
- [dynamic-routing-initialization](dynamic-routing-initialization.md) | 2025-09-13-103229 | initialization | Lazy initialization system for dynamic routing components with error handling, performance optimization, and graceful degradation patterns
  - use-when:
...
- [efficient-fallback](efficient-fallback.md) | 2025-09-11-0000 | integration | Graceful null-check patterns and efficient fallback mechanisms that eliminate exceptions for expected behavior
  - use-when:
...
- [emoji-elimination-systematic-replacement](emoji-elimination-systematic-replacement.md) | 2025-09-12-174343 | infrastructure | Comprehensive emoji removal and replacement system with 47+ mapped emojis, text equivalents, and batch processing for clean CLI interface design
  - use-when:
...
- [end-to-end-testing-scenarios](end-to-end-testing-scenarios.md) | 2025-09-11-0000 | testing | Comprehensive E2E testing framework with flexible scenario execution, realistic backend service mocking, performance monitoring, and systematic validation of complete user journeys across multiple interface types
  - use-when:
...
- [enhanced-backendconfig-schema](enhanced-backendconfig-schema.md) | 2025-09-11-0000 | foundation | Enhanced BackendConfig interface with comprehensive connection specification and backward compatibility
  - use-when:
...
- [enhanced-menu-integration](enhanced-menu-integration.md) | 2025-09-13-103229 | integration | Hybrid integration pattern for combining new CLI design systems with existing menu infrastructure while maintaining backward compatibility
  - use-when:
...
- [enhanced-skin-registration-validation](enhanced-skin-registration-validation.md) | 2025-09-11-0000 | foundation | Comprehensive validation pipeline for Universal Skin Engine registration with version compatibility checks and conflict detection
  - use-when:
...
- [enhanced-validation-testing](enhanced-validation-testing.md) | 2025-09-11-0000 | testing | Comprehensive test coverage for autonomous validation script extension generation with production safety requirements
  - use-when:
...
- [error-handler](utilities/core/error-handler.md) | 2025-09-14T18:10:00Z | core-infrastructure | Centralized error handling to standardize 695 catch blocks with consistent error wrapping, recovery strategies, and minimal usage footprint
  - use-when:
...
- [error-recovery](error-recovery.md) | 2025-09-11-0000 | foundation | Implement structured fallback rendering system that maintains system availability during component failures
  - use-when:
...
- [event-utils](utilities/core/event-utils.md) | 2025-09-14T21:30:00Z | core-infrastructure-utility | Centralized event utilities to eliminate 528 EventEmitter uses with typed event management, automatic cleanup, and minimal-footprint API design
  - use-when:
...
- [factory-registry-with-context-management](factory-registry-with-context-management.md) | 2025-09-11-0000 | foundation | Factory registration systems with context-dependent dependencies, error boundaries and graceful degradation
  - use-when:
...
- [factory-utils](utilities/core/factory-utils.md) | 2025-09-14T19:10:00Z | core-infrastructure | Shared factory orchestration utilities that standardize creation pipelines across connection, adapter, and session components.
  - use-when:
...
- [file-based-handoff-infrastructure](file-based-handoff-infrastructure.md) | 2025-09-11-0000 | foundation | Structured file-based communication system with JSON schemas, automated cleanup, and comprehensive error handling
  - use-when:
...
- [generic-agent-template](generic-agent-template.md) | 2025-09-11-0000 | foundation | Project-agnostic Analysis Agents with context isolation and file-based handoff communication
  - use-when:
...
- [http-protocol-communication](http-protocol-communication.md) | 2025-09-11-0000 | infrastructure | Real HTTP implementation with PCL service-specific API integration, enhanced headers and request options, and comprehensive error handling
  - use-when:
...
- [hybrid-cli-development-testing](hybrid-cli-development-testing.md) | 2025-09-12-113834 | testing-integration | 5-phase synthesis approach for CLI development with agent interaction capabilities, multi-category validation, and context preservation
  - use-when:
...
- [integration-test-framework-transition](integration-test-framework-transition.md) | 2025-09-11-0000 | testing | Transition from private property mocking to public API testing with real component validation
  - use-when:
...
- [interface-adapter-integration-testing](interface-adapter-integration-testing.md) | 2025-09-11-0000 | testing | Comprehensive integration testing framework with MockTemplumOrchestrator implementation for systematic validation of interface adapter scenarios
  - use-when:
...
- [ipc-protocol-communication](ipc-protocol-communication.md) | 2025-09-11-0000 | integration | Real IPC implementation with service-specific enhancements and real-time message handling
  - use-when:
...
- [library-module-interop-resolution](library-module-iterop-resolution.md) | 2025-09-11-0000 | foundation | Systematic resolution of ESModule interop conflicts in TypeScript library imports
  - use-when:
...
- [logger](utilities/core/logger.md) | 2025-09-14T18:05:00Z | core-infrastructure | Centralized logging infrastructure to eliminate 2,810 console.log/warn/error calls across 75+ files with structured, contextual logging
  - use-when:
...
- [mcp-integration-preservation-ui-changes](mcp-integration-preservation-ui-changes.md) | 2025-09-12-174343 | integration | Maintain MCP Channel compatibility and agent-CLI interaction capabilities during major UI transformations while preserving backward compatibility and command mapping
  - use-when:
...
- [mcp-pty-integration](mcp-pty-integration.md) | 2025-09-11-0000 | foundation | Mock-ready PTY foundation with comprehensive session lifecycle management for agent-CLI interaction
  - use-when:
...
- [minimal-compilation-stabilization-pattern](minimal-compilation-stabilization-pattern.md) | 2025-09-11-0000 | foundation | Focused stabilization approach addressing dependency installation and test file fixes while documenting interface issues for systematic resolution
  - use-when:
...
- [mock-real-api-alignment](mock-real-api-alignment.md) | 2025-09-11-0000 | foundation | Unifies mock interfaces with real implementation APIs to prevent compilation errors and integration failures
  - use-when:
...
- [mock-real-api-contract-testing](mock-real-api-contract-testing.md) | 2025-09-11-0000 | testing | Contract testing to ensure mock/real API consistency with automated validation
  - use-when:
...
- [multi-strategy-service-discovery](multi-strategy-service-discovery.md) | 2025-09-11-0000 | infrastructure | Intelligent multi-strategy discovery system that automatically finds backend services using registry-based, configuration-based, and endpoint scanning strategies with graceful fallback
  - use-when:
...
- [node.js-type-system-alignment](node.js-type-system-alignment.md) | 2025-09-11-0000 | foundation | Proper import syntax, variable naming conventions, and Node.js type system integration
  - use-when:
...
- [observability-infrastructure](observability-infrastructure.md) | 2025-09-11-0000 | foundation | Complete observability infrastructure with centralized logging, metrics collection, alerting, and integration with existing dependency injection system
  - use-when:
...
- [pcl-component-integration-unified](pcl-component-integration-unified.md) | 2025-08-27-0000 | integration | Complete real PCL component integration with performance measurement, method validation, and comprehensive health analysis
  - use-when:
...
- [pcl-enhanced-rendering](pcl-enhanced-rendering.md) | 2025-09-11-0000 | integration | Enhanced rendering pipeline with type-specific styling, content enhancement, and theme integration for PCL components
  - use-when:
...
- [pcl-rendering-integration-bridge-pattern](pcl-rendering-integration-bridge.md) | 2025-09-11-0000 | integration | Comprehensive PCL Rendering Adapter that bridges Universal Skin Engine with Phoenix Code Lite's proven rendering patterns
  - use-when:
...
- [production-readiness-validation](production-readiness-validation.md) | 2025-09-11-0000 | testing | Comprehensive validation for production deployment requirements using real system metrics
  - use-when:
...
- [progressive-enhancement-terminal-ui](progressive-enhancement-terminal-ui.md) | 2025-09-12-174343 | infrastructure | Environment capability detection with multi-layer fallback strategies and adaptive UI enhancement selection for optimal terminal experience across all platforms
  - use-when:
...
- [protocol-communication-overview](protocol-communication-overview.md) | 2025-09-11-0000 | infrastructure | Complete real protocol communication implemented through three specialized patterns for different backend services
  - use-when:
...
- [protocol-utils](utilities/core/protocol-utils.md) | 2025-09-14T21:31:45Z | core-infrastructure-utility | Unified protocol utilities for IPC/HTTP/WebSocket connection management optimization with confidence-validated message processing and shared protocol abstractions
  - use-when:
...
- [real-implementation-integration](real-implementation-integration.md) | 2025-09-11-0000 | integration | Systematic connection to existing real implementations with proper error handling and fallback coordination
  - use-when:
...
- [registry-utils](utilities/registry-utils.md) | 2025-09-15T12:00:00Z | core-infrastructure | Confidence-validated registry foundation replacing bespoke lifecycle, validation, and duplicate detection logic scattered across interface and command registries
  - use-when:
...
- [resilience-utils-consolidation-pattern](utilities/resilience-utils.md) | 2025-09-15T00:00:00Z | resilience-infrastructure | Unified resilience utilities consolidating fallback strategies, performance monitoring, and rollback decision logic into a single chainable API for consistent system resilience
  - use-when:
...
- [session-management-unified](session-management-unified.md) | 2025-08-29-0000 | integration | Enterprise-grade session state management with comprehensive error recovery and cross-interface coordination
  - use-when:
...
- [skin-versioning-system](skin-versioning-system.md) | 2025-09-11-0000 | infrastructure | Comprehensive semantic versioning system with multi-version storage, conflict resolution, compatibility validation, and automated migration framework
  - use-when:
...
- [templum-resource-management-unified](templum-resource-management-unified.md) | 2025-09-11-0000 | infrastructure | Enterprise-grade resource management system with allocation tracking, policy enforcement, service health monitoring, and automated cleanup
  - use-when:
...
- [templumerror-integration](templumerror-integration.md) | 2025-09-11-0000 | foundation | Standardized error handling pattern with typed error interfaces, utility functions, and consistent error categorization
  - use-when:
...
- [terminal-state-management](terminal-state-management.md) | 2025-09-11-0000 | infrastructure | Prevents terminal state corruption when using inquirer in CLI applications
  - use-when:
...
- [terminal-ui-components](terminal-ui-components.md) | 2025-09-11-0000 | integration | Complete terminal UI components system with interactive search, progress bars, spinners, and responsive layout management
  - use-when:
...
- [test-health-monitoring](test-health-monitoring.md) | 2025-09-11-0000 | foundation | Comprehensive test infrastructure health monitoring with pre-commit hooks, coverage reality checks, and continuous validation
  - use-when:
...
- [test-infrastructure-repair](test-infrastructure-repair.md) | 2025-09-11-0000 | foundation | Systematic repair of TypeScript type system consistency and test compilation issues
  - use-when:
...
- [test-type-system-alignment](test-type-system-alignment.md) | 2025-09-11-0000 | foundation | Align test interfaces with implementation types to resolve TypeScript compilation failures in dual type system architecture
  - use-when:
...
- [type-conversion](type-conversion.md) | 2025-09-11-0000 | foundation | Type-safe conversion utilities that bridge interface gaps while maintaining full type safety
  - use-when:
...
- [typescript-configuration-optimization](typescript-configuration-optimization.md) | 2025-09-02-0000 | configuration | Optimize TypeScript configuration for enhanced library compatibility and build performance
  - use-when:
...
- [unified-type-system](unified-type-system.md) | 2025-09-11-0000 | foundation | Complete type system architecture with error hierarchy, signal types, and compilation compatibility
  - use-when:
...
- [universal-interface-orchestration](universal-interface-orchestration.md) | 2025-09-11-0000 | integration | Orchestrates interface switching between multiple interface types while preserving session state and coordinating Universal Skin Engine rendering
  - use-when:
...
- [universal-skin-engine](universal-skin-engine.md) | 2025-09-11-0000 | foundation | Comprehensive universal rendering engine that handles multiple interface types with consistent theming, version management, and cross-platform compatibility
  - use-when:
...
- [unused-variable-cleanup-automation](unused-variable-cleanup-automation.md) | 2025-09-11-0000 | quality | Automated script that intelligently distinguishes between unused imports and variables for ESLint cleanup
  - use-when:
...
- [vscode-extension-activation-pattern](vscode-extension-activation-pattern.md) | 2025-09-11-0000 | foundation | Comprehensive VSCode extension activation with webview providers, command registration, graceful degradation, and resource cleanup
  - use-when:
...
- [vscode-extension-configuration](vscode-extension-configuration.md) | 2025-09-11-0000 | foundation | Systematic package.json configuration for converting Node.js CLI applications to VSCode extensions
  - use-when:
...
- [vscode-extension-integration-system](vscode-extension-integration-system.md) | 2025-09-11-0000 | integration | Comprehensive VSCode extension integration with service discovery, connection management, interface switching, and resource cleanup
  - use-when:
...
- [vscode-service-tree-provider](vscode-service-tree-provider.md) | 2025-09-11-0000 | infrastructure | Implement conditional display logic using BackendCapabilityProfile to show only relevant information based on backend capabilities, with visual type indicators
  - use-when:
...
- [websocket-protocol-communication](websocket-protocol-communication.md) | 2025-09-11-0000 | integration | Real WebSocket implementation with service-specific enhancements and real-time bidirectional messaging
  - use-when:
