...
name: event-utils-utility-consolidation-pattern
...
import { handleError } from './error-handler-utility';
...
export class EventUtils {
  ...
  static {
    ...
    this.globalBus.setMaxListeners(200);
  }
  ...
  static get globalBus(): TypedEventEmitter<any> {
    return this.globalBus as TypedEventEmitter<any>;
  }
  ...
  static cleanup(): void {
    ...
    // Clear global bus
    this.globalBus.removeAllListeners();
  ...
  static getDiagnostics(): EventDiagnostics {
    ...
    return {
      ...
      contextStats,
      globalBusListeners: this.globalBus.eventNames().length
    };
  }
}
