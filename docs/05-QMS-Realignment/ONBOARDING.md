...
- `05-Aims-and-Objectives.md`: define measurable targets for the internal tooling.
- `10-Solution-Alignment.md`: map aims to Templum/PCL/Haruspex/Validation System capabilities.
- `15-Traceability-Matrix.md`: connect VDL2 requirements → aims → tooling features → evidence.
...
3. Confirm whether new information exists for safety classification or cybersecurity scope; if yes, update `00-Problem-Statement.md` and flag it in `20-Progress-and-Gaps.md`.
