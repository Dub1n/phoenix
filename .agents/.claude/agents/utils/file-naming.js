...
exports.DEFAULT_NAMING_CONFIG = void 0;
exports.generateHandoffFilename = generateHandoffFilename;
exports.generateTimestamp = generateTimestamp;
exports.parseHandoffFilename = parseHandoffFilename;
exports.generateInputFilename = generateInputFilename;
exports.generateOutputFilename = generateOutputFilename;
exports.isValidHandoffFilename = isValidHandoffFilename;
exports.generateTaskId = generateTaskId;
/**
 * Default configuration for file naming
 */
exports.DEFAULT_NAMING_CONFIG = {
 ...
 */
function generateHandoffFilename(naming) {
    const { phase, type, task_id, timestamp } = naming;
    const { extension, separator } = exports.DEFAULT_NAMING_CONFIG;
 ...
 */
function parseHandoffFilename(filename) {
    const { extension, separator } = exports.DEFAULT_NAMING_CONFIG;
    // Remove extension
 ...
 */
function generateInputFilename(phase, task_id, timestamp) {
 ...
 */
function generateOutputFilename(phase, task_id, timestamp) {
    return generateHandoffFilename({
        phase,
        type: 'results',
        task_id,
 ...
 */
function isValidHandoffFilename(filename) {
