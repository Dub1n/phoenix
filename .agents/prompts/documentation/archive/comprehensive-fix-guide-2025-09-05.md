...
[ ] -- 3.5: Update Task Status [~|B|?]
[ ] Step 4: Task Discovery Protocol
...
6. **TodoWrite**:
   - Add the implementation steps as tasks to your todo list underneath 'Step 1: Implementation Strategy'

### Step 1.5: Escalation Evaluation
...
**After implementing complex solution, add TASK-ID tag for knowledge transfer**:
...
// Validation-Required: pattern-compliance, performance-baseline, architectural-alignment
// Pattern-Info: { approach: "approach-used", alternatives: "considered", trade-offs: "made", architectural-impact: "details" }
```

**Enhanced Tag Requirements for Complex Tasks**:

- [ ] Pattern name (existing or new) with architectural context
- [ ] Complexity score (6-10 for comprehensive tasks)
- [ ] Full implementation context including business rationale
- [ ] Dependencies and architectural constraints
- [ ] Comprehensive Pattern-Info including alternatives considered and trade-offs
...
- [ ] **TASK-ID Tag Applied**: Comprehensive knowledge transfer tag added
...
1. **Mark Status**: Update task to appropriate status [~|B|?]
